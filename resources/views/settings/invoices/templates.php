                                ...
                                <tbody >
                                    ...
                                    <td width="43.33%">
                                        ...
                                        <td width="23.33%">
                                            ...
                                            <p class="mb-1 text-gray-600 fs-6 text-nowrap"><?php echo getVatNoLabel() ?>: <span class="font-gray-900 text-nowrap">{{:gstNo}}</span></p>
                                        </td>
                                    ...
                                    <tbody>
                                        <tr style="vertical-align:top;">
                                            <td width="43.33%" class="pe-3">
                                                ...
                                                <p class=" mb-1 font-black-900" style="max-width:220px;"><strong><?php echo __('messages.common.address') . ':' ?> </strong> 185/18, Ani complex, Kamarajar Road, Karamadai, Coimbatore - 641104, Tamil Nadu, India.</p>
