                            ...
                            <div class="card card-xxl-stretch mb-xl-3">
                                ...
                                <div class="card-body pt-2">
                                    ...
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <!--end::Bullet-->
                                        <!--begin::Checkbox-->
                                        <div class="form-check form-check-custom  mx-5">
                                            <input class="form-check-input" type="checkbox" value=""/>
                                        </div>
                                        <!--end::Checkbox-->
                                        <!--begin::Description-->
        ...
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <!--end::Separator-->
                    <!--begin::Textarea-->
                    <textarea class="form-control  mb-8" rows="3"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Sathya Prakash</a>
                                        <div class="fw-bold text-gray-400">sakthiyprakash@gmail.com</div>
                                    </div>
                                    <!--end::Details-->
                                </div>
                                <!--end::Details-->
                            ...
                            <div class="col-lg-6 mb-10 mb-lg-0">
                                ...
                                <div class="nav flex-column">
                                    ...
                                    <div class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6"
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            <!--begin::Radio-->
                                            <div class="form-check form-check-custom  form-check-success me-6">
