...
<div class="mb-5 col-lg-3 col-sm-12">
    {{ Form::label('job', __('messages.invoice.job') . ':', ['class' => 'form-label required mb-3']) }}
    {{ Form::select('job', [
        'pending'   => __('messages.invoice.pending'),
        'delivered' => __('messages.invoice.delivered'),
        'canceled'  => __('messages.invoice.canceled')
    ], isset($invoice) ? $invoice->job : 'pending', ['class' => 'form-select', 'id' => 'job', 'required']) }}
</div>
