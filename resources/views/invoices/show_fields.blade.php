...
<div>
    ...
    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="col-xxl-9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-6">
                                        <div class="d-flex flex-column mb-md-10 mb-5 mt-3 mt-md-0">
                                            <label for="name"
                                                class="pb-2 fs-4 text-gray-600">{{ __('messages.invoice.job') . ':' }}</label>
                                            <span
                                                class="fs-4 text-gray-800">{{ __("messages.invoice.{$invoice->job}") ?? 'N/A' }}</span>
                                        </div>
                                    </div>
        ...
        <div class="tab-pane fade show" id="paymentHistory" role="tabpanel">
            <div class="row">
                <div class="col-lg-12 ">
                    <livewire:payment-history-table invoiceId="{{ $invoice->id }}" lazy />
                </div>
            </div>
        </div>
        @if ($invoice->parentInvoice)
        ...
        <div class="tab-pane fade show" id="recurringInvoices" role="tabpanel">
            <div class="row">
                <div class="col-lg-12 ">
                    <livewire:recurring-invoices-table invoiceId="{{ $invoice->id }}" lazy />
                </div>
            </div>
        </div>
    </div>
